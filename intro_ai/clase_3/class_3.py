...
if __name__ == '__main__':
    ...
    # Regresión lineal con una constante
    ...
    lrb_2_y_plot = linear_regression_b.model[0] * x_plot + linear_regression_b.model[1]+linear_regression.model * x_plot**2
    ...
    plt.plot(x_plot, lrb_2_y_plot, color='c', label=f'ConstantModel(MSE={ct_mse:.3f})')
    plt.legend()
    plt.show()