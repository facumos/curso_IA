...
class QueryMeanPrecisionK(object):

    def __call__(self, predicted_rank, truth_relevance, query_ids, K):

        """
        Definition:
        Mean Precision K is the mean of the Precision of each query against the value K?
        Precision K for a query is the number of true positives documents divided by K
